drop function if exists public.update_admin_invitation(uuid, text, jsonb);
...
grant execute on function public.update_admin_invitation(uuid, text, jsonb, text) to authenticated;
